...
public class JPreparedStatement extends JStatement implements java.sql.PreparedStatement{
	...
	//批处理任务
	List<Collection<ParameterContext>> batchArgs;
	...
	public ResultSet executeQuery() throws SQLException {
		...
		return executeQueryInternal(originalSQL, this.parameterSettings.values());
	}

	public int executeUpdate() throws SQLException {
		check(parameterSettings);
		return executeUpdateInternal(originalSQL, autoGeneratedKeys, columnIndexes, columnNames, this.parameterSettings.values());
	}
...
//	}
	...
	public void addBatch() throws SQLException {
		if (batchArgs == null) {
			batchArgs = new LinkedList<Collection<ParameterContext>>();
		}
		check(parameterSettings);
