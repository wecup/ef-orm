...
public class JStatementImpl extends PreparedStatementExecutorCommon implements JStatement {

	private static final Logger log = LoggerFactory.getLogger(JStatementImpl.class);
	...
	public JStatementImpl(ReentrantConnection routingConnection, int resultsetType, int resultSetConcurrency,ExecutionPlan plan) {
	...
	protected int executeUpdateInternal(String sql, int autoGeneratedKeys, int[] columnIndexes, String[] columnNames, Map<Integer, ParameterContext> sqlParam, SqlType sqlType, JStatementImpl statementImp) throws SQLException {
		try {
...
//			}
	 ...
	 * @throws SQLException
	 */
	protected int executeUpdateInternalInTry(String sql, int autoGeneratedKeys, int[] columnIndexes, String[] columnNames, Map<Integer, ParameterContext> sqlParam, SqlType sqlType, JStatementImpl tStatementImp) throws SQLException {
