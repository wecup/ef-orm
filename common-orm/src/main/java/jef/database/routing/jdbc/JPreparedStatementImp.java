...
public class JPreparedStatementImp extends JStatementImp implements JPreparedStatement {

	private static final Logger log = LoggerFactory.getLogger(JPreparedStatementImp.class);

	private final String originalSQL;

	List<Map<Integer, ParameterContext>> pstArgs;

//	public JPreparedStatementImp(ConnectionManager connectionManager, String originalSQL, Bootstrap bootStrap) {
...
//	}
	...
	public JPreparedStatementImp(String sql, ReentrantConnection routingConnection, int resultsetType, int resultSetConcurrency) {
		super(routingConnection,resultsetType,resultSetConcurrency);
