...
public class JStatement implements java.sql.Statement {
	...
	protected int executeUpdateInternal(String sql, int autoGeneratedKeys, int[] columnIndexes, String[] columnNames, Map<Integer, ParameterContext> sqlParam, SqlType sqlType, JStatement statementImp) throws SQLException {
		try {
	 ...
	 * @throws SQLException
	 */
	protected int executeUpdateInternalInTry(String sql, int autoGeneratedKeys, int[] columnIndexes, String[] columnNames, Map<Integer, ParameterContext> sqlParam, SqlType sqlType, JStatement tStatementImp) throws SQLException {
