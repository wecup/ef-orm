...
public class TestColumntypesDb2entity extends TestColumntypesDb2entity82{
	...
	public TestColumntypesDb2entity(){
	}

	public TestColumntypesDb2entity(int serialfield){
		this.serialfield = serialfield;
	}


public enum Field implements jef.database.Field{smallintfield,int2field,intfield2,bigintfield,decimalfield,numericfield,numericfield2,realfield,floatfield,doublefield,doublefield2,serialfield,serialfield2,moneyfield,varcharfield1,varcharfield2,charfield1,charfield2,varbitfield1,varbitfield2,bitfield1,bitfield2,cidrfield,inetfield,macaddrfield,uuidfield,booleanfield1,booleanfield2,datefield,timestampfield1,timestampfield2,timefield1,timefield2,intervalfield,binaryfield,textfield,tsvectorfield,tsqueryfield,xmlfield,txidfield,boxfield,circlefield,linefield,lsegfield,pathfield,pointfield,polygonfield}
}
