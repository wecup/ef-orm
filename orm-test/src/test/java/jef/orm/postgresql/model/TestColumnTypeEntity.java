...
/**
 * 用于测试由Entity生成PostgreSQL数据库表对象的实体类
 * 
...
public class TestColumnTypeEntity extends jef.database.DataObject {
	...
	/**
	 * 因指定为IDENTITY(即GUID), 故db中的类型是uuid.
	 */
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private String uuidField;

	private List<TestColumnTypeEntity> tt1;

	private TestColumnTypeEntity[] tt2;

	private Map<String, TestColumnTypeEntity> tt3;
	...
	public List<TestColumnTypeEntity> getTt1() {
		return tt1;
	}

	public void setTt1(List<TestColumnTypeEntity> tt1) {
		this.tt1 = tt1;
	}

	public TestColumnTypeEntity[] getTt2() {
		return tt2;
	}

	public void setTt2(TestColumnTypeEntity[] tt2) {
		this.tt2 = tt2;
	}

	public Map<String, TestColumnTypeEntity> getTt3() {
		return tt3;
	}

	public void setTt3(Map<String, TestColumnTypeEntity> tt3) {
		this.tt3 = tt3;
	}

	public enum Field implements jef.database.Field {
		intField, intField2, bigintField, longField, floatField, floatField2, floatField3, doubleField, doubleField2, field1, field2, dateField, dateField2, boolField, boolField2, binaryField, textField, uuidField
	}
}
